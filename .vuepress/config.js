...
module.exports = {
    title: 'OpenCore Telepítési Útmutató',
    head: [
        ['meta', {
            name: 'theme-color',
            content: '#3eaf7c'
    ...
    themeConfig: {
        lastUpdated: true,
        repo: 'https://github.com/duszmox/OpenCore-Install-Guide',
        editLinks: true,
        editLinkText: 'Segíts nekünk fejleszteni ezt az oldalt!',
        logo: '/homepage.png',
        nav: [{
            text: 'Dortania Útmutatók',
            ariaLabel: 'Language Menu',
            items: [{
                    text: 'Dortania Főoldala',
                    link: 'https://dortania.github.io/'
                },
                {
                    text: 'Első lépsek az ACPI-al',
                    link: 'https://duszmox.github.io/Getting-Started-With-ACPI/'
                },
                {
                    text: 'OpenCore Telepítés Utáni útmutató',
                    link: 'https://duszmox.github.io/OpenCore-Post-Install/'
                },
                {
                    text: 'OpenCore Multiboot',
                    link: 'https://duszmox.github.io/OpenCore-Multiboot/'
                },
                {
                    text: 'Videókárta vásárlási útmutató',
                    link: 'https://duszmox.github.io/GPU-Buyers-Guide/'
                },
                {
                    text: 'Vezetéknélküli adapter vásárlási útmutató',
                    link: 'https://duszmox.github.io/Wireless-Buyers-Guide/'
                },
                {
                    text: 'Mit ne vegyél útmutató',
                    link: 'https://duszmox.github.io/Anti-Hackintosh-Buyers-Guide/'
                },
            ]
        }, ],
        sidebar: [{
            ...
            },
            {
                ...
                collapsable: false,
                children: [{
                        title: 'Intel Asztali config.plist',
                        collapsable: true,
                        sidebarDepth: 1,
                        children: [
                    ...
                    {
                        title: 'AMD Asztali config.plist',
                        collapsable: true,
                        sidebarDepth: 1,
                        children: [
                            '/AMD/fx',
